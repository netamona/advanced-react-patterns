...
Make the state of the custom component optionally controlled (like when using
input "value" prop). Allows users full control of the state.

We can use useRef to track the value of a variable in the previous render.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=Advanced%20React%20Patterns%20%F0%9F%A4%AF&e=06%3A%20Control%20Props&em=netanella1%40gmail.com).
