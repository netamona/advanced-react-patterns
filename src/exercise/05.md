...
Pass the reducer function as prop to allow maximum control of the custom hook or
component. Make sure to export the default reducer function, so users can only
override specific parts and use the default behaviour for the others.
