...
Pass the reducer function as prop to allow control of actions state changes for
the custom hook or component. Make sure to export the default reducer function,
so users can only override specific parts and use the default behaviour for the
others.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=Advanced%20React%20Patterns%20%F0%9F%A4%AF&e=05%3A%20State%20Reducer&em=netanella1%40gmail.com).
